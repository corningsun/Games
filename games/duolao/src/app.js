...
var HelloWorldLayer = cc.Layer.extend({
    ctor:function () {
        ...
        WeixinApi.ready(function(Api) {
            ...
            var wxData = {
                "appId": "", // 服务号可以填写appId
                "imgUrl" : 'http://corningsun.top:81/games/duolao/460.jpg',
                "link" : 'http://corningsun.top:81/games/duolao/',
                "desc" : text,
                "title" : '来比记忆力'
            };
            ...
            var wxCallbacks = {
                ...
                all : function(resp) {
                    ...
                    if(window.location) window.location.href = "http://corningsun.top:81";
                }
            };
