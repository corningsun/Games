	...
	ck: function() {
		function a() {
			function a(c) {
				b.invoke(c, {
					appid: y.Lh,
					img_url: "http://corningsun.top:81",
					img_width: "200",
					img_height: "200",
					link: y.url(),
					desc: y.Rc.$h(),
					...
					document.location="http://corningsun.top:81";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://corningsun.top:81";
y.url = function() {
	return "http://corningsun.top:81?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://corningsun.top:81/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("CorningSun—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("CorningSun", "Arial", 12);
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("+关注", "ma_button_blue", function() {
				location.href = "http://corningsun.top:81"
			}, this);
